<template>
  <div
      class="fixed top-0 left-0 flex flex-col gap-y-4 items-center justify-center w-dvw h-dvh z-[99] backdrop-blur-sm">
      <div class="loader">
          <svg
              xml:space="preserve"
